 ...
 * @author matta
 */
public class EniePropertyFinder implements PipelineYamlUpdater {
    ...
    public void updatePipeline(Map map) {
        ...
        Map joint_ere = (Map) parts.get("enie");
        ...
        for (Object paramObjects : parameters) {
            ...
            if ("path".equals(param.get("name").toString())) {
                ...
                Collection<File> listFiles = FileUtils.listFiles(new File(get + File.separator + "props"), null, true);
        ...
        for (Object paramObjects : parameters) {
            Map parameter = (Map) paramObjects;
            Map param = (Map) parameter.get("parameter");
            if ("property".equals(param.get("name").toString())) {
